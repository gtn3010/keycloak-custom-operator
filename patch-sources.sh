...
addAnnotation \
  ...
  $HOME/.m2/keycloak-core/org/keycloak/representations/idm/GroupRepresentation.java
...
addAnnotation \
  ...
  $HOME/.m2/keycloak-core/org/keycloak/representations/idm/RealmRepresentation.java
...
addAnnotation \
  ...
  $HOME/.m2/keycloak-core/org/keycloak/representations/idm/CredentialRepresentation.java

addAnnotation \
  "private MultivaluedHashMap<String, String> config;" \
  "@io.fabric8.crd.generator.annotation.SchemaFrom(type = org.keycloak.representations.overrides.MultivaluedStringStringHashMap.class)" \
  $HOME/.m2/keycloak-core/org/keycloak/representations/idm/ComponentRepresentation.java
...
addAnnotation \
  ...
  $HOME/.m2/keycloak-core/org/keycloak/representations/idm/ComponentExportRepresentation.java
...
addAnnotation \
  ...
  $HOME/.m2/keycloak-core/org/keycloak/representations/idm/authorization/ScopeRepresentation.java
